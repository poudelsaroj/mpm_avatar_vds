...
--smplx_gender ${GENDER} \
--src_mesh_path ${DATADIR}/a${ACTOR}_s${SEQUENCE}/smplx_fitted/000${START_IDX}/smplx_icp.obj \
--src_param_path ${DATADIR}/a${ACTOR}_s${SEQUENCE}/smplx_fitted/000${START_IDX}/smplx_icp_param.pth \
...
--cloth_obj ${DATADIR}/a${ACTOR}_s${SEQUENCE}/shirts_sim.obj \
--fix_v /root/AnisoPhysDreamer/data/a2_s1/fix_v_upper.npy \
--iteration 10 \
...
--fix_v /root/AnisoPhysDreamer/data/a2_s1/fix_v_lower.npy \
--iteration 0 \
